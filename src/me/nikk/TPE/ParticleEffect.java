...
public enum ParticleEffect
{
  EXPLOSION_NORMAL(
    ...
    "blockcrack", 37, -1, new ParticleProperty[] { ParticleProperty.REQUIRES_DATA }),  BLOCK_DUST(
    ...
    "mobappearance", 41, 8, new ParticleProperty[0]),  DRAGON_BREATH(
    ...
    "dragonbreath", 42, 9, new ParticleProperty[0]),  END_ROD(
    ...
    "endRod", 43, 9, new ParticleProperty[0]),  DAMAGE_INDICATOR(
    ...
    "damageIndicator", 44, 9, new ParticleProperty[0]),  SWEEP_ATTACK(
    ...
    "sweepAttack", 45, 9, new ParticleProperty[0]),  FALLING_DUST(
    ...
    "fallingdust", 46, 10, new ParticleProperty[] { ParticleProperty.REQUIRES_DATA });
